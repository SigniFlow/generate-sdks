...
#java -jar .\swagger-codegen\openapi-generator-cli.jar author template -g php-laravel -o "./swagger-templates/php-laravel"
...
java -jar .\swagger-codegen\openapi-generator-cli.jar author template -g ruby -o "./swagger-templates/ruby"
